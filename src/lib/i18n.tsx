...
const MESSAGES: Record<Lang, Messages> = {
  en: {
    ...
    'schedules.pickDate': 'Pick a date',
    'schedules.pickDateTitle': 'Select date',
    'schedules.time': 'Time',
    ...
    'schedules.editName': 'Name',
    'schedules.editDate': 'Date',
    'schedules.editTime': 'Time',
    'schedules.generateMonth': 'Generate Month',
    'schedules.month': 'Month',
    'schedules.year': 'Year',
    'schedules.generate': 'Generate',
    'schedules.generateIgnoreLabel': 'Ignore schedules (optional)',
    'schedules.generateIgnoreHelp': 'Selected schedules will not be created for that month.',
    'schedules.generateResultTitle': 'Month generated',
    'schedules.generateResultSubtitle': 'Schedules have been added to your list.',
    'schedules.generateResultCreated': '{count} created',
    'schedules.generateResultSkipped': '{count} skipped (already existed)',
    'schedules.generateResultIgnored': '{count} ignored',
    ...
    'review.sync.tokenHelp': 'Tip: you can paste “Authorization: Bearer …” and we’ll extract the token.',
    'review.sync.openLogin': 'Open Louveapp login',
    'review.sync.ministryId': 'Ministry ID',
    'review.sync.rememberToken': 'Remember token on this device (1h)',
    ...
    'review.sync.noSchedulesToSync': 'No schedules to sync.',
  ...
  'pt-BR': {
    ...
    'schedules.pickDate': 'Escolher data',
    'schedules.pickDateTitle': 'Selecionar data',
    'schedules.time': 'Horário',
    'schedules.today': 'Hoje',
    'schedules.clear': 'Limpar',
    'schedules.addInstrument': 'Adicionar instrumento...',
    'schedules.removeSlot': 'Remover slot',
    'schedules.edit': 'Editar',
    'schedules.editTitle': 'Editar escala',
    'schedules.editName': 'Nome',
    'schedules.editDate': 'Data',
    'schedules.editTime': 'Horário',
    'schedules.generateMonth': 'Gerar Mês',
    'schedules.month': 'Mês',
    'schedules.year': 'Ano',
    'schedules.generate': 'Gerar',
    'schedules.generateIgnoreLabel': 'Ignorar escalas (opcional)',
    'schedules.generateIgnoreHelp': 'As escalas selecionadas não serão criadas para este mês.',
    'schedules.generateResultTitle': 'Mês gerado',
    'schedules.generateResultSubtitle': 'As escalas foram adicionadas à sua lista.',
    'schedules.generateResultCreated': '{count} criada(s)',
    'schedules.generateResultSkipped': '{count} já existia(m)',
    'schedules.generateResultIgnored': '{count} ignorada(s) (opção)',
    ...
    'review.sync.token': 'Bearer token',
    'review.sync.tokenHelp': 'Dica: você pode colar “Authorization: Bearer …” e vamos extrair o token.',
    'review.sync.openLogin': 'Abrir login do Louveapp',
    'review.sync.ministryId': 'ID do Ministério',
    'review.sync.rememberToken': 'Lembrar token neste dispositivo (1h)',
    ...
    'review.sync.noSchedulesToSync': 'Nenhuma escala para sincronizar.',
